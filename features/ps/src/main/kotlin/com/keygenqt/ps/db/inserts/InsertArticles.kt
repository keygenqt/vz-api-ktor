...
object InsertArticles {
    ...
    fun insertAsymptoticComplexity(
        ...
        ArticleEntity.new {
            ...
            // content
            this.description = """
                Часто, для решения задач недостаточно получить только результат, так же важно получить эффективный способ ее решения. О сложность алгоритма решаемой вами задачи.
            """.trimIndent()
